...
## `r font_col("ggplot2", "#E69F00")` and the `r font_col("tidyverse", "#E69F00")` are ideal for `r font_col("scientific communication", "#56B4E9")`

---
class: inverse-ns, center

# Data Visualization with R
## `r font_col("ggplot2 and the tidyverse are ideal for scientific communication", "#6C7B7F")`
...
---
# `r font_col("Tidy Meta-Analysis", "#E69F00")`
## `meta_analysis()`
...
---
# `r font_col("Influence Plot", "#E69F00")`
## `sensitivity()`
...
# Resources
## [R for Data Science](http://r4ds.had.co.nz/): free online and in-print book
## [DataCamp](https://www.datacamp.com/): ggplot2 courses and tidyverse courses
## the [ggplot2 book](https://smile.amazon.com/ggplot2-Elegant-Graphics-Data-Analysis/dp/331924275X/ref=sr_1_2?ie=UTF8&qid=1524362742&sr=8-2&keywords=ggplot2)
